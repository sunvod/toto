...
class TotoTrainer:
    """
    A trainer class for the Toto model that handles autoregressive training for time series forecasting.
    
    This is a modified version of TotoForecaster with gradients enabled for training.
    This class wraps a TotoBackbone model and provides methods to generate predictions with gradients.
    ...
    # Removed @torch.no_grad() to enable gradient computation for training
    def generate_mean(
        self,
        ...
        # Removed .detach() to keep gradients for training
